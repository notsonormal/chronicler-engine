...
This project relies on a comprehensive suite of unit and integration tests as the ultimate source of truth for behavior.
...
Always read `CODING_STANDARDS.md` before doing code reviews.