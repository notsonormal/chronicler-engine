...
- [`../explanation/architecture.md`](../explanation/architecture.md) — §10 quality-attribute table cites INV-001, INV-003, INV-004, INV-004b, INV-005, INV-006, INV-007.
- [`./triggers.md`](./triggers.md) — INV-002 mutation sequence is the same one the trigger phase observes.
