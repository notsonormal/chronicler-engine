...
fn test_settings_recover_from_poisoned_rwlock() {
    ...
    let app_state = AppState {
        ...
        application_service: Arc::new(DefaultApplicationService::new(Arc::new(Storage::new_in_memory()), Arc::new(Storage::new_in_memory()), Arc::new(std::sync::RwLock::new(AppSettings::default())), CancellationToken::new(), Arc::new(std::sync::atomic::AtomicBool::new(false)), Arc::clone(&game_service))),
