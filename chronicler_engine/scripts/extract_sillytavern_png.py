...
def main():
    parser = argparse.ArgumentParser(description="Extract SillyTavern JSON metadata from V2 PNG character cards.")
    parser.add_argument("input", nargs='+', help="Input PNG files or directories")
    parser.add_argument("--char-out", default="data/characters", help="Output directory for character JSON files")
    parser.add_argument("--world-out", default="data/world", help="Output directory for world JSON files")
    parser.add_argument("--world-name", default="Extracted World", help="Name of the generated World Card")
