...
# Combined coverage from lib + fragment_tests
# Reads from tmp/coverage/coverage.json (created by skill workflow)
import os
...
# Use totals directly from JSON (more accurate than recalculating)
...
# Each file has a "summary" field with line coverage
