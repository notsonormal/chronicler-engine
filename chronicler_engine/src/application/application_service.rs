...
impl ApplicationService for DefaultApplicationService {
    fn process_action(
        ...
        let mut game_state = crate::application::context::try_load_state(&ctx)?;
        ...
        if ctx.cancel_token.is_cancelled() {
            let mut gs = crate::application::context::try_load_state(&ctx)?;
    ...
    fn edit_history(
        ...
        let mut guard = crate::application::context::try_load_state(&ctx)?;
