...
fn test_assemble_prompt_text_with_all_sections() {
    ...
    let result = preset.assemble_prompt_text(&["Rule 1".into()], Some("Keep it short."));
...
fn test_assemble_prompt_text_skips_empty_sections() {
    ...
    let result = preset.assemble_prompt_text(&[], None);
...
fn test_assemble_prompt_text_order() {
    ...
    let result = preset.assemble_prompt_text(&["RULE".into()], None);
