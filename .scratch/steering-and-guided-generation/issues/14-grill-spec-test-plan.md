...
6. **Impersonate output type.** Should impersonate output be `MessageType::Input` (as proposed) or a distinct type such as `Dialogue`?

## Answer

To be recorded during the grilling session.
