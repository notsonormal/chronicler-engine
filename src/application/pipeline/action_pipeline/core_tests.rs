...
fn test_pipeline_no_duplicate_narration() {
    ...
    let _outcome = app
        .pipeline
        .run_from_input(state, "test input".to_string(), false, None);
...
fn test_pipeline_empty_input_produces_continuation() {
    ...
    let _outcome = app
        .pipeline
        .run_from_input(state, String::new(), false, None);
...
fn test_pipeline_quantifier_detects_movement() {
    ...
    let _outcome = app
        .pipeline
        .run_from_input(state, "go to room 2".to_string(), false, None);
...
fn test_pre_main_snapshot_saved_before_narration() {
    ...
    let _outcome = app
        .pipeline
        .run_from_input(state, "examine the room".to_string(), false, None);
...
fn test_pre_event_snapshot_saved_before_continuation() {
    ...
    let _outcome = app
        .pipeline
        .run_from_input(state, "examine the npc".to_string(), false, None);
...
fn test_delayed_llm_completes_without_deadlock() {
    ...
    let _outcome = app
        .pipeline
        .run_from_input(state, "look around".to_string(), false, None);
...
async fn test_pipeline_cancels_during_trigger_continuation() {
    ...
    let handle = tokio::task::spawn_blocking(move || {
        app_clone
            .pipeline
            .execute_action_with_inputs("enter the shop".to_string(), false, None);
    });
