...
- `AGENTS.md`, `docs/AGENTS.md`, `tests/AGENTS.md`: these files are pushed to the context window of any agent working in this repo. They should be used incredibly sparingly, usually only for **navigation pointers** to other files.
- `CONTEXT.md`, `docs/diataxis/reference/coding_standards/*`: these file are read during review, not implementation. Add **navigation pointers** to docs folders if the standards file gets more than 1,000 lines long.
