...
Structure:
- Answer in the first sentence. Then give each paragraph a bolded one- or two-word sentence-case lead (`Mechanism.` `Evidence.` `Where it breaks.`) so the labels guide the reader. Hold paragraphs to about four lines.
